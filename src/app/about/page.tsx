    ...
    <>
      ...
      <section className={styles.content}>
        ...
        <div className={styles.bio}>
          <p>I&apos;m a frontend engineer based in Los Angeles with roots in Atlanta and a degree in graphic design. That design background is the lens I bring to every line of code I write. I care about how things look just as much as how they work.</p>
